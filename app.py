    ...
    if st.session_state.employees.empty:
        ...
        if loc:
            ...
            if jarak_meter <= sch_data['radius_m']:
                ...
                # Cek status cadar dari database
                is_cadar = emp_data.get('is_cadar', False)
                show_buttons = False
                
                # JIKA PEGAWAI BERCADAR
                if is_cadar:
                ...
                # JIKA PEGAWAI TIDAK BERCADAR (Gunakan Face AI)
                else:
                ...
                # TAMPILKAN TOMBOL MASUK DAN PULANG JIKA FOTO DIAMBIL
                if show_buttons:
...
# ==========================================
    ...
    if df_emp.empty:
        ...
        # Tombol download dengan format .xlsx
        st.download_button(
